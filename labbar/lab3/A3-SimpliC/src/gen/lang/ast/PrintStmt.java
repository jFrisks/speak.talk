...
/**
 * @ast node
 * @declaredat /Users/lucas/Documents/LTH/edan_new_new/edan65-compilers/labbar/lab2/A2-SimpliC/src/jastadd/calc.ast:10
 * @astdecl PrintStmt : Stmt ::= Expr;
...
public class PrintStmt extends Stmt implements Cloneable {
   ...
   * @apilevel high-level
   */
  public PrintStmt setExpr(Expr node) {
    setChild(node, 0);
    return this;
  }
  /**
